  ...
  return (
    <>
        ...
        >
          <div className="d-flex justify-content-center">
            <p style={{ maxWidth: "60%", marginTop: "2%" }}>
              EduAssist is a Complete, end-to-end Solution for your Institute
              (School, College, University, Academy, Coaching Center, etc).
              EduAssist is an Online, Web based System which enables you to
          ...
          <div className="d-flex justify-content-center">
            <p style={{ maxWidth: "60%", marginTop: "2%" }}>
              EduAssist is a powerful educational system with all backend
          ...
          <div className="d-flex justify-content-center">
            <p style={{ maxWidth: "60%", marginTop: "2%", marginBottom: "2%" }}>
              EduAssist, is a result of our years of
      ...
      >
        ...
        >
          <h1 className="d-flex justify-content-center mt-5 text-white">
            EduAssist statistics summary
          </h1>
        </div>
        <div className="conatiner" style={{ marginTop: "3%" }}>
          <div className="row">
            <div className="container col-md-8 d-flex justify-content-center text-white gap-5 pb-5">
      ...
      >
        <div className="conatiner pb-5">
          ...
          <p className="d-flex justify-content-center ">
            Get EduAssist - Our solution is guaranteed to save your time, reduce
            expenses and boost efficiency.
          </p>
          <div className="row gap-2 justify-content-center mt-5">
            <div className="col-4">
              <div
          ...
          <div className="row col-md-12 justify-content-center mt-5">
            <div className="card" style={{ width: "20rem" }}>
              ...
              <div className="card-body text-black">
                <h5 className="card-title text-center">Administration</h5>
            ...
            <div className="card mt-5" style={{ width: "20rem" }}>
              ...
              />
              <div className="card-body text-black">
                <h5 className="card-title text-center ">Parents</h5>
                <p className="card-text">
                  Some quick example text to build on the card title and make up
                  the bulk of the card's content.
                </p>
      ...
      <div>
        ...
        >
          <div className="container p-4  justify-contetnt-center">
            <div className="row  justify-contetnt-center">
              <div className="col-lg-12 col-md-12 mb-md-0">
                <h3 className="text-white text-center">EduAssist</h3>
          ...
          >
            <span>© 2023 EduAssist - All rights reserved</span>
          </div>
        </footer>
      </div>
    </>
